...
def generate_launch_description():
    ...
    mcu_port_arg   = DeclareLaunchArgument('mcu_port',   default_value='/dev/serial/by-id/usb-Silicon_Labs_CP2102N_USB_to_UART_Bridge_Controller_56db11f39d70f011a6a68c301045c30f-if00-port0')
