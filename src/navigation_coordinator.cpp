...
public:
    ...
    NavigationCoordinator() : Node("navigation_coordinator") {
        ...
        std::string default_path = "/mnt/c/Users/David/OneDrive/Documents/Projects/PortaMailCapstone";
        std::string default_yaml = default_path + "/locations.yaml";
...
private:
    ...
    void start_navigation(const Location& loc) {
        ...
        goal_msg.pose.pose.orientation.w = loc.w; // Simplified, ideally use quat
